        ...
        <div className="max-container" style={{ position: 'relative', zIndex: 1 }}>
            <div className="page-hero-content reveal">
                ...
                <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap' }}>
                    ...
                    <Link to="#" style={{ display: 'inline-block', padding: '12px 28px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.3)', color: 'white', textDecoration: 'none', fontWeight: '600', transition: 'all 0.3s ease' }}>Explore Platform</Link>
                </div>
            </div>
        </div>
    </section>
